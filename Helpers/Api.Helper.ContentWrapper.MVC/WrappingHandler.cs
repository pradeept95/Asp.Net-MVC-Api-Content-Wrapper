...
namespace Api.Helper.ContentWrapper.MVC
{
        ...
        private static HttpResponseMessage BuildApiResponse(HttpRequestMessage request, HttpResponseMessage response)
        {
            ...
            if (response.TryGetContentValue(out content) && !response.IsSuccessStatusCode)
            {
                ...
                if (error != null)
                {
                    ...
                    data = new APIResponse((int)code, ResponseMessageEnum.Failure.GetDescription(), null, false, apiError);
            ...
            else
            {
                if (response.TryGetContentValue(out content))
                {
                    ...
                    if (type.Name.Equals("APIResponse"))
                    {
                        ...
                        data = new APIResponse(code, ResponseMessageEnum.Success.GetDescription(), content, true);
                }
                else
                {
